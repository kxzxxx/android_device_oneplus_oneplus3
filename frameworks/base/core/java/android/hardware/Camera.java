            ...
            case CAMERA_MSG_DNG_META_DATA:
                ...
                if (mOneplusCallback != null
                    ...
                    */
                    ...
                    //CaptureRequest req = (new CaptureRequest.Builder(new CameraMetadataNative(mMetadata),false,-1))
                    //    .build();
                    //CaptureResultExtras resExtras= new CaptureResultExtras(-1,-1,-1,-1,-1,-1,-1);
                    CaptureResult result=new CaptureResult(new CameraMetadataNative(mMetadata),-1);//req,resExtras);
